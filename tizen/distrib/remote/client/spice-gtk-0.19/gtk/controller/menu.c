/* menu.c generated by valac 0.20.0, the Vala compiler
...
SpiceCtrlMenu* spice_ctrl_menu_find_id (SpiceCtrlMenu* self, gint id) {
	...
	_tmp2_ = self->items;
	{
		...
		for (item_it = item_collection; item_it != NULL; item_it = item_it->next) {
			SpiceCtrlMenuItem* _tmp3_;
			SpiceCtrlMenuItem* item = NULL;
			_tmp3_ = _g_object_ref0 ((SpiceCtrlMenuItem*) item_it->data);
			item = _tmp3_;
			{
				SpiceCtrlMenuItem* _tmp4_;
				gint _tmp5_;
				gint _tmp6_;
				SpiceCtrlMenuItem* _tmp10_;
				SpiceCtrlMenu* _tmp11_;
				gint _tmp12_;
			...
			{
				{
					...
					gint _tmp7_;
					const gchar* _tmp8_;
					SpiceCtrlMenuItem* _tmp9_;
					SpiceCtrlMenuItem* item;
					SpiceCtrlMenuItem* _tmp10_;
					gint _tmp11_;
					SpiceCtrlMenu* _tmp12_ = NULL;
					SpiceCtrlMenu* parent;
					SpiceCtrlMenu* _tmp13_;
					SpiceCtrlMenu* _tmp15_;
					SpiceCtrlMenuItem* _tmp16_;
					SpiceCtrlMenuItem* _tmp17_;
					_tmp5_ = itemstr;
