...
static void virt_viewer_display_spice_send_keys(VirtViewerDisplay *display,
                                                ...
                                                int nkeyvals);
#ifdef CONFIG_MARU
static void virt_viewer_display_spice_send_hwkey_press(VirtViewerDisplay *display,
                                                const guint *keyvals,
                                                int nkeyvals);
static void virt_viewer_display_spice_send_hwkey_release(VirtViewerDisplay *display,
                                                const guint *keyvals,
                                                int nkeyvals);
static void virt_viewer_display_spice_send_rotation_type(VirtViewerDisplay *display,
                                                const guint *keyvals,
                                                int nkeyvals);
static void virt_viewer_display_spice_send_hostkbd_onoff(VirtViewerDisplay *display,
                                                const guint *keyvals,
                                                int nkeyvals);
static void virt_viewer_display_spice_send_close_type(VirtViewerDisplay *display,
                                                const guint *keyvals,
                                                int nkeyvals);
static void virt_viewer_display_spice_req_sdb_port(VirtViewerDisplay *display,
                                                const guint *keyvals,
                                                int nkeyvals);
#endif
...
#ifdef CONFIG_MARU
    dclass->send_hwkey_press = virt_viewer_display_spice_send_hwkey_press;
    dclass->send_hwkey_release = virt_viewer_display_spice_send_hwkey_release;
    dclass->send_rotation_type = virt_viewer_display_spice_send_rotation_type;
    dclass->send_hostkbd_onoff = virt_viewer_display_spice_send_hostkbd_onoff;
    dclass->send_close_type = virt_viewer_display_spice_send_close_type;
    dclass->req_sdb_port = virt_viewer_display_spice_req_sdb_port;
#endif
...
#ifdef CONFIG_MARU
static void
virt_viewer_display_spice_send_hwkey_press(VirtViewerDisplay *display,
                                    const guint *keyvals,
                                    int nkeyvals)
{
    VirtViewerDisplaySpice *self = VIRT_VIEWER_DISPLAY_SPICE(display);
    ...
    spice_display_send_hwkeys(self->priv->display, keyvals, nkeyvals, SPICE_DISPLAY_KEY_EVENT_PRESS);
}

static void
virt_viewer_display_spice_send_hwkey_release(VirtViewerDisplay *display,
                                    const guint *keyvals,
                                    int nkeyvals)
{
    VirtViewerDisplaySpice *self = VIRT_VIEWER_DISPLAY_SPICE(display);
    ...
    spice_display_send_hwkeys(self->priv->display, keyvals, nkeyvals, SPICE_DISPLAY_KEY_EVENT_RELEASE);
}

static void
virt_viewer_display_spice_send_rotation_type(VirtViewerDisplay *display,
                                    const guint *keyvals,
                                    int nkeyvals)
{
    VirtViewerDisplaySpice *self = VIRT_VIEWER_DISPLAY_SPICE(display);
    ...
    spice_display_send_rotation(self->priv->display, keyvals, nkeyvals, SPICE_DISPLAY_KEY_EVENT_PRESS);
}

static void
virt_viewer_display_spice_send_hostkbd_onoff(VirtViewerDisplay *display,
                                    const guint *keyvals,
                                    int nkeyvals)
{
    VirtViewerDisplaySpice *self = VIRT_VIEWER_DISPLAY_SPICE(display);
    ...
    spice_display_send_hostkbd(self->priv->display, keyvals, nkeyvals, SPICE_DISPLAY_KEY_EVENT_PRESS);
}

static void
virt_viewer_display_spice_send_close_type(VirtViewerDisplay *display,
                                    const guint *keyvals,
                                    int nkeyvals)
{
    VirtViewerDisplaySpice *self = VIRT_VIEWER_DISPLAY_SPICE(display);
    ...
    spice_display_send_close(self->priv->display, keyvals, nkeyvals, SPICE_DISPLAY_KEY_EVENT_PRESS);
}

static void
virt_viewer_display_spice_req_sdb_port(VirtViewerDisplay *display,
                                    const guint *keyvals,
                                    int nkeyvals)
{
    VirtViewerDisplaySpice *self = VIRT_VIEWER_DISPLAY_SPICE(display);
    ...
    spice_display_get_sdbport(self->priv->display, keyvals, nkeyvals, SPICE_DISPLAY_KEY_EVENT_PRESS);
}
#endif
