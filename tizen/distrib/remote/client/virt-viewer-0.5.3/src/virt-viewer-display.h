...
#ifdef CONFIG_MARU
    void (*send_hwkey_press)(VirtViewerDisplay *display,
		      const guint *keyvals, int nkeyvals);
    void (*send_hwkey_release)(VirtViewerDisplay *display,
                      const guint *keyvals, int nkeyvals);
    void (*send_rotation_type)(VirtViewerDisplay *display,
                      const guint *keyvals, int nkeyvals);
    void (*send_hostkbd_onoff)(VirtViewerDisplay *display,
                      const guint *keyvals, int nkeyvals);
    void (*send_close_type)(VirtViewerDisplay *display,
                      const guint *keyvals, int nkeyvals);
    void (*req_sdb_port)(VirtViewerDisplay *display,
                      const guint *keyvals, int nkeyvals);
#endif
