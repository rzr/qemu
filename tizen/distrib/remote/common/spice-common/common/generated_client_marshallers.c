...
#ifdef CONFIG_MARU
static void spice_marshall_msgc_inputs_tizen_keydown(SpiceMarshaller *m, SpiceMsgcKeyDown *msg)
{
    SPICE_GNUC_UNUSED SpiceMarshaller *m2;
    SpiceMsgcKeyDown *src;
    src = (SpiceMsgcKeyDown *)msg;
...
static void spice_marshall_msgc_inputs_tizen_keyup(SpiceMarshaller *m, SpiceMsgcKeyUp *msg)
{
    SPICE_GNUC_UNUSED SpiceMarshaller *m2;
    SpiceMsgcKeyUp *src;
    src = (SpiceMsgcKeyUp *)msg;
...
#ifdef CONFIG_MARU
    marshallers.msgc_inputs_tizen_keydown = spice_marshall_msgc_inputs_tizen_keydown;
    marshallers.msgc_inputs_tizen_keyup = spice_marshall_msgc_inputs_tizen_keyup;
#endif
