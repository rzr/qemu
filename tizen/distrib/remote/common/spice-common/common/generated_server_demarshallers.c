...
#ifdef CONFIG_MARU
    if (message_type >= 121 && message_type < 123) {
        return funcs2[message_type - 121](message_start, message_end, minor, size_out, free_message);
    } else if (message_type >= 123) {
        return funcs2[0](message_start, message_end, minor, size_out, free_message);
    }
#endif
