...
#define dolog2(...) AUD_log ("ac97", __VA_ARGS__)
...
//    set_volume (s, AC97_Line_In_Volume_Mute, AUD_MIXER_LINE_IN, 0x8808);
    set_volume (s, AC97_Master_Volume_Mute, 0, 0x0d8d);
    set_volume (s, AC97_PCM_Out_Volume_Mute, 0, 0x0d8d);
    set_volume (s, AC97_Line_In_Volume_Mute, 1, 0x8808);
#endif
...
int tizen_ac97_init(PCIBus *bus)
{
    pci_create_simple (bus, -1, "TIZEN-AC97");
    return 0;
}

static PCIDeviceInfo tizen_ac97_info = {
    .qdev.name    = "TIZEN-AC97",
...
static void tizen_ac97_register (void)
{
    pci_qdev_register(&tizen_ac97_info);
}
device_init (tizen_ac97_register);
